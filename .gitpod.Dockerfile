...
# Get the latest version from https://developer.android.com/ndk/downloads/index.html
    ...
    FLUTTER_VERSION=v1.9.1+hotfix.4-stable \
...
ENV PATH=$PATH:${ANDROID_HOME}:${ANDROID_HOME}/tools:${ANDROID_HOME}/tools/bin:${ANDROID_NDK_HOME}:${FLUTTER_HOME}:${FLUTTER_HOME}/bin:${FLUTTER_HOME}/bin/cache/dart-sdk
